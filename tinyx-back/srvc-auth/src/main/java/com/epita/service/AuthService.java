...
public class AuthService {
    ...
    public Response createUser(String username, String password) {
        ...
        UserContract user = new UserContract(UUID.randomUUID(), username, hashPassword(password), new Date(), new Date());
    ...
    public Response login(String username, String password) {
        ...
        UserContract user = authRepository.getUserByUsernameAndHashPassword(username, hashPassword(password));
        if (user == null) {
    ...
    public Response updatePassword(UUID id, String password) {
        ...
        UserContract user = authRepository.getUser(id);
        if (user == null) {
